 ...
 * @param type - The type of operation (withdraw, deposit, mint).
 * @param amount - The amount being input by the user.
 * @param showAlert - Function to display an alert message to the user.
 * @param mint - Optional parameter for minting amount validation.
